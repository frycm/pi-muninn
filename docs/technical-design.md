...
The index stores canonical record hashes and normalized terms. It narrows lexical candidates; canonical filters and ranking still decide results. Unicode normalization, exact matches, prefixes and bounded one-edit matches share the same analyzer. Relation expansion, correction precedence, Git provenance and recency contribute to ranking. Optional explanations expose those contributions. The canonical scan and index must remain equivalent.
