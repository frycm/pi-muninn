 ...
 * for every budget it enforces — chunk size, tool output and the run transcript
 * handed to the outcome model — because all three are *caps*, not
 ...
 * result.
 *
 * One approximation in one place, so the budgets can never disagree about
 * what a token is.
 */
